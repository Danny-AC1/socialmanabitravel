...
export const EditPostModal: React.FC<EditPostModalProps> = ({ isOpen, post, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-900/60 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
        <div className="flex justify-between items-center p-5 border-b border-gray-100">
          <h2 className="text-xl font-bold text-gray-800">Editar Publicación</h2>
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              className="w-full bg-gray-50 border-gray-200 border rounded-xl p-3 h-32 resize-none focus:ring-2 focus:ring-cyan-500 outline-none transition-all"
              value={caption}
